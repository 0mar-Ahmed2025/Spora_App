...
class CodegenLoader extends AssetLoader{
  ...
  "account_created": {
    ...
    "description": "تم إنشاء الحساب بنجاح. يرجى المتابعة لإكمال إعداداتك."
  },
  "check_your_email": {
    "title": "تحقق من بريدك الإلكتروني",
    "description": "لقد أرسلنا لك معلومات لإعادة تعيين كلمة المرور الخاصة بك"
  },
  "login": {
    ...
    "mfa_required": "مطلوب المصادقة ثنائية العاملين. يرجى التحقق من حسابك.",
    "success": "تم تسجيل الدخول بنجاح!"
  },
  "register": {
    "title": "التسجيل في تطبيق سبورا",
  ...
  "mfa": {
    ...
    "description": "لقد أرسلنا رمز التحقق إلى عنوان بريدك الإلكتروني المسجل. يرجى إدخال الرمز للمتابعة.",
    "confirm_continue": "تأكيد ومتابعة",
    "resend_code_in": "إعادة إرسال الرمز خلال {} ثانية",
    "resend_code": "إعادة إرسال الرمز"
  },
  "dashboard": {
    "error_loading": "حدث خطأ أثناء تحميل البيانات",
    "connect_internet": "يرجى الاتصال بالإنترنت والمحاولة مرة أخرى",
    ...
    "security": {
      ...
      "subtitle": "تحديث كلمة المرور وإعدادات المصادقة الثنائية"
    },
    "settings": {
      "title": "إعدادات التطبيق",
      "subtitle": "اللغة، المظاهر وإعدادات التطبيق"
    },
    "hello": " مرحباً👋",
  ...
  "profile": {
    ...
    "unactive_account": "حساب غير نشط"
  },
  "security": {
    "title": "الأمان",
    "password": {
      "title": "كلمة المرور",
      "subtitle": "تغيير كلمة المرور وتأمين حسابك"
    },
    "mfa": {
      "title": "إعدادات المصادقة الثنائية (MFA)",
  ...
  "settings": {
    ...
    "profile": {
      "title": "الملف الشخصي",
      "subtitle": "تعديل تفاصيلك الشخصية والصورة الرمزية"
    },
    "security_password": {
    ...
    "notifications": {
      "title": "الإشعارات",
      "subtitle": "التحكم في التنبيهات وأصوات الإشعارات"
    },
  ...
  "create_report_title": "إنشاء بلاغ",
  "report_saved_success": "تم حفظ البلاغ بنجاح",
  "field_title": "العنوان",
  "error_title_invalid": "العنوان يجب أن يكون بين 3 و 80 حرفاً",
  "field_description": "الوصف",
  "error_description_invalid": "الوصف يجب أن يكون بين 10 و 500 حرفاً",
  ...
  "error_label": "الخطأ",
  "retries_label": "المحاولات",
  "category_technical": "مشكلة تقنية",
  "category_service": "مشكلة خدمة",
  "category_feedback": "ملاحظة",
  "category_other": "أخرى",
  "priority_low": "منخفضة",
  ...
  "mode_success": "نجاح",
  "mode_offline": "بدون إنترنت",
  "mode_timeout": "مهلة زمنية",
  "mode_serverError": "خطأ سيرفر",
  "mode_validationError": "خطأ بيانات",
  "network_unavailable": "الشبكة غير متاحة. تم الحفظ في الانتظار.",
...
static const Map<String,dynamic> _en = {
  ...
  "login": {
    ...
    "mfa_required": "MFA is required. Please verify your account.",
    "success": "Login successfully!"
  },
  "register": {
    "title": "Register to Spora app",
  ...
  "mfa": {
    ...
    "description": "We have sent a verification code to your registered email address. Please enter the 4-digit code to proceed.",
    "confirm_continue": "Confirm & Continue",
    "resend_code_in": "Resend code in {} seconds",
    "resend_code": "Resend Code"
  },
  "dashboard": {
    "error_loading": "Occurred happened while loading the data",
    "connect_internet": "Pleas Connect To Your Internet And Try Again",
    "quick_actions": "Quick Actions",
    "profile": {
      "title": "Profile",
      "subtitle": "See And Update Your Info"
    },
    "security": {
      "title": "Security And Authentication",
      "subtitle": "Update Password & MFA Settings"
    },
    "settings": {
      "title": "App Settings",
      "subtitle": "Language, Themes And App Settings"
    },
    "hello": " Hello👋",
  ...
  "profile": {
    ...
    "unactive_account": "Un Active Account"
  },
  "security": {
    "title": "Security",
    "password": {
  ...
  "settings": {
    ...
    "profile": {
      "title": "Profile",
      "subtitle": "Edit your personal details and avatar"
    },
    "security_password": {
    ...
    "notifications": {
      "title": "Notifications",
      "subtitle": "Control alerts and notification sounds"
    },
  ...
  "field_title": "Title",
  "error_title_invalid": "Title must be between 3 and 80 characters",
  "field_description": "Description",
  "error_description_invalid": "Description must be between 10 and 500 characters",
  ...
  "category_service": "Service Issue",
  ...
  "mode_serverError": "Server Error",
  "mode_validationError": "Validation Error",
  "network_unavailable": "Network unavailable. Saved in queue.",
...
static const Map<String,dynamic> _fa = {
  ...
  "create_report_title": "ایجاد گزارش",
  "report_saved_success": "گزارش با موفقیت ذخیره شد",
  "field_title": "عنوان",
  "error_title_invalid": "عنوان باید بین ۳ تا ۸۰ کاراکتر باشد",
  "field_description": "توضیحات",
  "error_description_invalid": "توضیحات باید بین ۱۰ تا ۵۰۰ کاراکتر باشد",
  "field_category": "دسته‌بندی",
  "field_priority": "اولولیت",
  "btn_camera": "دوربین",
  "btn_gallery": "گالری",
  ...
  "filter_all": "همه",
  "no_reports_found": "گزارشی یافت نشد",
  "error_label": "خطا",
  "retries_label": "تلاش مجدد",
  "category_technical": "مشکل فنی",
  "category_service": "مشکل سرویس",
  "category_feedback": "بازخورد",
  "category_other": "سایر",
  "priority_low": "کم",
  ...
  "mode_success": "موفقیت",
  "mode_offline": "آفلاین",
  "mode_timeout": "پایان مهلت",
  "mode_serverError": "خطای سرور",
  "mode_validationError": "خطای اعتبارسنجی",
  "network_unavailable": "شبکه در دسترس نیست. در صف ذخیره شد.",
